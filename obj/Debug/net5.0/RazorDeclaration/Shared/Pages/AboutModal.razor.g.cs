...
#line hidden
#nullable disable
    public partial class AboutModal : BaseComponent
    {
...
#nullable restore
#line 51 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Shared/Pages/AboutModal.razor"
      
    [Parameter] public string AssemblyVersion { get; set; }

    VersionInfo MyVersion = new VersionInfo();
    protected override void OnInitialized()
    {
        try
        {
            SLog.Write("Getting Assembly Version...!");
            AssemblyVersion = MyVersion.SetAssemblyVersion();
        }
        catch (Exception e)
        {
