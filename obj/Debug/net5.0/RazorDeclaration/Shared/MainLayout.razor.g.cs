...
#nullable restore
#line 84 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Shared/MainLayout.razor"
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        try
        {
            if (firstRender)
            {
                await JSRuntime.InvokeVoidAsync("BundledJS");
            }
        }
        catch (Exception ex)
        {
    ...
    public async Task<bool> IsAuthenticated()
    {
        try
        {
            ...
            if (user.Identity.IsAuthenticated)
            {
                ...
                await loginService.GetLoggedInUserDetailsFromServer("MainLayout");
                return true;
