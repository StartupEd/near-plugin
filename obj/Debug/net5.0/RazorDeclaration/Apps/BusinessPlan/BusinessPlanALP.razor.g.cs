...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/businessplan")]
    public partial class BusinessPlanALP : BaseComponent
    {
...
#nullable restore
#line 210 "/Users/ankitbuti/workspace/bigapple_corev5/UXs/Incubation/Apps/BusinessPlan/BusinessPlanALP.razor"
       
    private OneUX_SweetAlertBox ShowSweetAlertBox { get; set; }
    private string SearchString { get; set; }
    private List<BusinessPlan> BusinessPlans { get; set; }
    public BusinessPlan_ClientService ClientService;
    ...
    private string DeleteBPlanId { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        try
        {
            ...
            ClientService = new BusinessPlan_ClientService(EngineServices.MarketNetwork);
            await LoadData();
        }
        catch (Exception ex)
        {
    ...
    protected async Task LoadData()
    {
        ...
        {
            BusinessPlans = await ClientService.GetNetworkBusinessPlansFromServer(UXUtility.LoggedInUserRole);
            BusinessPlans = BusinessPlans.OrderByDescending(bp => bp.Core.CreatedAt.ToString()).ToList();
        }
        else
        {
            BusinessPlans = await ClientService.GetBusinessPlanByUserId(UXUtility.LoggedInUser.Id);
            BusinessPlans = BusinessPlans.OrderByDescending(bp => bp.Core.CreatedAt.ToString()).ToList();
        }
    ...
    protected void EditBusinessPlanAsync(string BPlanId)
    {
        ...
        {
            string BplanName = BusinessPlans.Find(plan => plan.Id == BPlanId).VentureName;
            navigationManager.NavigateTo($"businessplan/{BPlanId}/{BplanName}/edit");
        }
    }
    ...
    public async void DeleteBplan(string BplanId)
    {
        try
        {
            ...
            BusinessPlans = await ClientService.DeleteObject(BusinessPlans, BplanId);
            if (BusinessPlans != null)
            {
                StateHasChanged();
