...
namespace StartupEd.UX.Incubation.Apps.SketchPad
{
    #line hidden
...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/sketchpad/create")]
    [Microsoft.AspNetCore.Components.RouteAttribute("/sketchpad/{SketchId}/{SketchName}")]
    public partial class SketchpadOLP : BaseComponent
    {
...
#nullable restore
#line 105 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Apps/SketchPad/SketchpadOLP.razor"
    ...
    private Sketch_ClientService ClientService { get; set; }
    ...
    protected async override Task OnInitializedAsync()
    {
        try
        {
            ...
            ClientService = new Sketch_ClientService(EngineServices.MarketNetwork);
            if (SketchId != null)
            {
