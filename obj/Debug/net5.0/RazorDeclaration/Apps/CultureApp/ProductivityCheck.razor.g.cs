...
#nullable disable
#nullable restore
#line 2 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Apps/CultureApp/ProductivityCheck.razor"
using StartupEd.Engine.MarketNetwork.CultureApp;
...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/app/culture/productivitycheck")]
    public partial class ProductivityCheck : BaseComponent
    {
...
#nullable restore
#line 414 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Apps/CultureApp/ProductivityCheck.razor"
    ...
    public Culture Model { get; set; }
    public CultureService_ClientService ModelService { get; set; }
    ...
    protected override void OnInitialized()
    {
        ...
        ModelService = new CultureService_ClientService(EngineServices.MarketNetwork);

    }
    public async Task SubmitCulture()
    {
        ...
        try
        {
            ...
            {
                ToastService.ShowSuccess(" Submitted");
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        try
        {
            if (firstRender)
            {
                await JSRuntime.InvokeVoidAsync("rangeSlider");
                await JSRuntime.InvokeVoidAsync("formElementsRepeater");
    ...
    public Dictionary<string, string> Routes = new Dictionary<string, string>()
    {
        ...
        { "Productivity Tracker","/app/culture/productivitycheck"}
    };
