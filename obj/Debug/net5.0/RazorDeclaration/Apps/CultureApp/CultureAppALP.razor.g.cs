...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/app/culture")]
    public partial class CultureAppALP : BaseComponent
    {
...
#nullable restore
#line 106 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Apps/CultureApp/CultureAppALP.razor"
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        try
        {
            if (firstRender)
            {
                await JSRuntime.InvokeVoidAsync("todolist");
            }
        }
        catch (Exception ex)
        {
