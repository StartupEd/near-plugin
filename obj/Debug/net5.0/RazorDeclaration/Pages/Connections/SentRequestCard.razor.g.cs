...
#line hidden
#nullable disable
    public partial class SentRequestCard : BaseComponent
    {
...
#nullable restore
#line 41 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/Connections/SentRequestCard.razor"
    ...
    [Parameter] public EventCallback<string> OnCancelRequestCallBack { get; set; }
    ...
    protected async void CancelSentRequestAsync()
    {
        ...
        if (result == true)
        {
            await OnCancelRequestCallBack.InvokeAsync(Model.Id);
