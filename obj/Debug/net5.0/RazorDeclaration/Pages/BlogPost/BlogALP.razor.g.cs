...
#nullable restore
#line 95 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/BlogPost/BlogALP.razor"
    ...
    public User_ClientService User_clientService { get; set; }
    public List<User> Users { get; set; }
    public List<CachedUser> cachedUserss { get; set; }
    public List<Reaction<Blog>> Reactions { get; set; }
    protected override async Task OnInitializedAsync()
    {
        try
        {
            ...
            Reactions = new List<Reaction<Blog>>();
            await LoadData();
    ...
    protected bool IsVisible(Blog blog)
    {
    ...
    public async Task<List<CachedUser>> GetReactions(Blog model)
    {
