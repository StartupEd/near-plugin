...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/event/detail/{Id}")]
...
#nullable restore
#line 254 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/Events/EventOLP.razor"
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            ...
            Model = await ModelService.GetEventFromServer(Id);
    ...
    public async void ApplyButtonClick()
    {
        try
        {
            ...
            RegistrationModel.EmailId = loginService.LoggedInUser.Email;
            RegistrationModel.Name = loginService.LoggedInUser.Name;
            ...
            if (response.IsSuccessStatusCode)
            {
                ButtonClick = true;
                StateHasChanged();
                ToastService.ShowSuccess("User Registration Successfully ", "Success");
