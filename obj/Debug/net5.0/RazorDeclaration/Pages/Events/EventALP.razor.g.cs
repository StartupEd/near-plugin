...
#nullable restore
#line 88 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/Events/EventALP.razor"
    ...
    protected bool IsVisible(Events AllEvents)
    {
        if (string.IsNullOrEmpty(SearchString))
            return true;

        if (AllEvents.Name.ToUpper().StartsWith(SearchString) || AllEvents.Name.ToLower().StartsWith(SearchString))
            return true;
