...
#nullable restore
#line 95 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/FeedbackPage.razor"
       
    public FeedbackModel Model { get; set; }
    public FeedbackModel_ClientService ModelService;

    protected override void OnInitialized()
    {
        Model = new FeedbackModel();
        Model.Name = loginService.LoggedInUser.Name;
        Model.Email = loginService.LoggedInUser.Email;
        ModelService = new FeedbackModel_ClientService(EngineServices.MarketNetwork);
    ...
    public async Task SubmitFeedback()
    {
        ...
        try
        {
            ...
            {
                ToastService.ShowSuccess("Feedback Submitted", "Success");
