...
#nullable restore
#line 29 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Kanban/KanbanItem.razor"
    ...
    public MyTask_ClientService ClientService { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            ClientService = new MyTask_ClientService(EngineServices.MarketNetwork);
            StateHasChanged();
        }
        catch (Exception ex)
        {
