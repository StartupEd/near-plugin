...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/cartexp")]
    public partial class TryCartExperience : BaseComponent
    {
...
#nullable restore
#line 95 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/Commerce/TryCartExperience.razor"
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            try
            {
                if (firstRender)
                {
                    await JSRuntime.InvokeVoidAsync("addCart");
                }
            }
            catch (Exception ex)
            {
