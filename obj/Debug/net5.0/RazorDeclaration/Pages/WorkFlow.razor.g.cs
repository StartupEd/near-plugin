...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/workflow")]
    public partial class WorkFlow : BaseComponent
    {
...
#nullable restore
#line 16 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/WorkFlow.razor"
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        try
        {
            if (firstRender)
            {
                await JSRuntime.InvokeVoidAsync("chevronProgressBar");
            }
        }
        catch (Exception ex)
        {
