...
#nullable disable
#nullable restore
#line 2 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Search/SearchResults.razor"
...
#nullable disable
#nullable restore
#line 3 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Search/SearchResults.razor"
...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/search/results/all/Keyword/{Query}")]
...
#nullable restore
#line 160 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Search/SearchResults.razor"
      
    [Parameter] public string Query { get; set; }
    public User_ClientService ClientService { get; set; }
    public Events_ClientService EventsClientService { get; set; }
    public BusinessPage_ClientService BusinessPageClientService { get; set; }
    public Group_ClientService GroupClientService { get; set; }
    public IncubationProgram_ClientService IncubationProgramClientService { get; set; }
    public List<Hits2<SearchClass>> SearchData { get; set; }
    public List<Hits2<SearchClass>> SearchDataUser { get; set; }
    public List<Hits2<SearchClass>> SearchDataEvents { get; set; }
    public List<Hits2<SearchClass>> SearchDataBusinessPage { get; set; }
    public List<Hits2<SearchClass>> SearchDataGroup { get; set; }
    public List<Hits2<SearchClass>> SearchDataIncubationProgram { get; set; }
    ...
    protected async override Task OnInitializedAsync()
    {
        try
        {
            ...
            EventsClientService = new Events_ClientService(EngineServices.MarketNetwork);
            BusinessPageClientService = new BusinessPage_ClientService(EngineServices.MarketNetwork);
            GroupClientService = new Group_ClientService(EngineServices.MarketNetwork);
            IncubationProgramClientService = new IncubationProgram_ClientService(EngineServices.MarketNetwork);
