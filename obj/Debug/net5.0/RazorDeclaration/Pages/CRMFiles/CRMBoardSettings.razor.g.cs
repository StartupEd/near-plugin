...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/CRM/boardSettings/{CRMId}")]
...
#nullable restore
#line 86 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/CRMFiles/CRMBoardSettings.razor"
  
    [Parameter] public string CRMId { get; set; }
    public CRM Model = new CRM();
    public CRM_ClientService _ClientService { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            ...
            _ClientService = new CRM_ClientService(EngineServices.MarketNetwork);
            await LoadCRM();
