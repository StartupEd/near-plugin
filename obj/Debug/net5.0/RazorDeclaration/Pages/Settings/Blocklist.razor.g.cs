...
#nullable disable
    ...
    [Microsoft.AspNetCore.Components.RouteAttribute("/settings/blocking/{LoggedinUserId}")]
...
#nullable restore
#line 32 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Settings/Blocklist.razor"
       
    [Parameter] public string LoggedinUserId { get; set; }
    private List<User> BlockedUsers = new List<User>();
    private List<Profile> BlockedProfiles = new List<Profile>();
