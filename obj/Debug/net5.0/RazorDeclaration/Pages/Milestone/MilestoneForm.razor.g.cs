...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/milestone")]
...
#nullable restore
#line 230 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Milestone/MilestoneForm.razor"
      
    private List<Events> AppliedEvents = new List<Events>();
    private Events_ClientService EventService { get; set; }
    private List<Certification> ClaimedCertificates { get; set; }
    private Certification Model = new Certification();
    private Certification_ClientService CertificateService { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        CertificateService = new Certification_ClientService(EngineServices.MarketNetwork);
    ...
    {
        Events MyEvent = AppliedEvents.Find(e => e.Core.Id == eventId);
