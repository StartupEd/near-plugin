...
#nullable restore
#line 26 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Milestone/CertificateCollection.razor"
           
        private StartupEdCertificate ConfirmDisplayCertificate { get; set; }
        private List<Certification> AllCertificates = new List<Certification>();
        private Certification_ClientService CertificateService { get; set; }
        private Certification MyCertificate { get; set; } = new Certification();
