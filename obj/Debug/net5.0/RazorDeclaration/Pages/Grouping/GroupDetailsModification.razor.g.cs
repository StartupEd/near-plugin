...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/community/details/edit/{Id}")]
    public partial class GroupDetailsModification : BaseComponent
    {
...
#nullable restore
#line 125 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/Grouping/GroupDetailsModification.razor"
    ...
    private Groups GroupInfo { get; set; } = new Groups();
    ...
    private async Task SubmitGroupInformation()
    {
        try
        {
            ...
            GroupInfo.Description = await JSRuntime.InvokeAsync<string>("getEditorValue", "communityDescription");            
            HttpResponseMessage response = await GroupService.PutAsync(GroupInfo);
            if (response.IsSuccessStatusCode)
            {
                SLog.Write("Group Updated Successfully..!!");
                ToastService.ShowSuccess("Group Info Updated Successfully..!!");
                navigationManager.NavigateTo($"/community/details/{Id}");
            }
        }
        catch (Exception ex)
        {
    ...
    {
        GroupInfo.CoverImage = await UploaderService.UploadFile(src);
        StateHasChanged();
    }
    ...
    public async Task OnInputFileChange(InputFileChangeEventArgs e)
    {
        ...
        foreach (var imageFile in e.GetMultipleFiles(maxAllowedFiles))
        {
            ...
            GroupInfo.CoverImage = await UploaderService.UploadFile(data);
            StateHasChanged();
        }
    }
