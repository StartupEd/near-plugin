...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/community")]
    public partial class GroupsLandingPage : BaseComponent
    {
...
#nullable restore
#line 73 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/Grouping/GroupsLandingPage.razor"
       
    private List<Groups> JoinedGroups { get; set; } = new List<Groups>();
    private List<Groups> RecommendedGroups { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            ...
            StateHasChanged();
            SLog.Write(RecommendedGroups.Count.ToString());
        }
    ...
    private async Task JoinPublicGroup(string groupId)
    {
        try
        {
            if (!string.IsNullOrEmpty(groupId))
            {
                ...
                {
                    navigationManager.NavigateTo("community/details/" + groupId);
    ...
    protected async ValueTask<ItemsProviderResult<Groups>> LoadGroupsData(ItemsProviderRequest request)
    {
        var results = RecommendedGroups;
        return new ItemsProviderResult<Groups>(results.Skip(request.StartIndex).Take(request.Count), results.Count());
    }
