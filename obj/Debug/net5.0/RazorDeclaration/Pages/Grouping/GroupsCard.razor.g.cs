...
#line hidden
#nullable disable
    public partial class GroupsCard : BaseComponent
    {
...
#nullable restore
#line 68 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Grouping/GroupsCard.razor"
       
    private OneUX_SweetAlertBox ShowSweetAlertBox { get; set; }
    private FileUploader_ClientService<Profile> UploaderService { get; set; }
    [Parameter] public Groups GroupDetail { get; set; } = new Groups();
    ...
    {
        GroupDetail.Core.ImageUrl = await UploaderService.UploadFile(src);
        StateHasChanged();
    }
