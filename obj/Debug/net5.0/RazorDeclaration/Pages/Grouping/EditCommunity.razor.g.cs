...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/community/{Id}/{GroupName}/edit")]
...
#nullable restore
#line 113 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Grouping/EditCommunity.razor"
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            ...
            notificationCommEditHubConnection = new HubConnectionBuilder().WithUrl(EngineServices.MarketNetwork.EndPoint + "/notificationhub").Build();
    ...
    public async Task OnInputFileChange(InputFileChangeEventArgs e)
    {
        ...
        foreach (var imageFile in e.GetMultipleFiles(maxAllowedFiles))
        {
            ...
            GroupInfo.Core.ImageUrl = await UploaderService.UploadFile(data);
            StateHasChanged();
        }
    }
