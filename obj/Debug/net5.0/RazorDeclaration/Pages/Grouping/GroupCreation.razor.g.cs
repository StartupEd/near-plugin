...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/community/new")]
    public partial class GroupCreation : BaseComponent
    {
...
#nullable restore
#line 73 "/Users/ankitbuti/workspace/bigapple/UXs/Incubation/Pages/Grouping/GroupCreation.razor"
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            ...
            Connections = await UserService.GetUserConnectionsListAsync(UXUtility.LoggedInUser.Id);
        }
        catch (Exception e)
        {
    ...
    private async Task SubmitGroupInformation()
    {
        try
        {
            ...
            bool result = await GroupService.PostGroupInfoAsync(GroupInfo);
            if (result)
            {
