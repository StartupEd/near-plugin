...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/businesspage/{Id}/{name}/edit")]
...
#nullable restore
#line 261 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/BPage/EditBPage.razor"
    ...
    public async Task OnInputFileChange(InputFileChangeEventArgs e)
    {
        ...
        foreach (var imageFile in e.GetMultipleFiles(maxAllowedFiles))
        {
            ...
            Model.Core.ImageUrl = await UploaderService.UploadFile(data);
            StateHasChanged();
