...
#nullable disable
#nullable restore
#line 1 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/JobPosting/ResumeUploaderModal.razor"
...
#nullable restore
#line 67 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/JobPosting/ResumeUploaderModal.razor"
      
    [Parameter]
    public JobPosting Posting { get; set; }
    [Parameter]
    public EventCallback Returncallback { get; set; }
    public AnyFile Model = new AnyFile();
    public Registration RegistrationModel { get; set; }
    public FileUploader_ClientService<AnyFile> UploaderService { get; set; }
    public AnyFile_ClientService ModelService { get; set; }
    public JobPosting_ClientService ClientService { get; set; }
    public Registration_ClientService Service { get; set; }
    ...
    {
        UploaderService = new FileUploader_ClientService<AnyFile>(EngineServices.MarketNetwork);
        ModelService = new AnyFile_ClientService(EngineServices.MarketNetwork);
        Service = new Registration_ClientService(EngineServices.MarketNetwork);
        ...
        notificationJobHubConnection = new HubConnectionBuilder().WithUrl(EngineServices.MarketNetwork.EndPoint + "/notificationhub").Build();
