...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/event/{Id}/{EventName}/edit")]
...
#nullable restore
#line 216 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/Pages/Event/EditEvent.razor"
    ...
    public async void SubmitModel()
    {
        try
        {
            ...
            Model.Description = await JSRuntime.InvokeAsync<string>("getEditorValue", "eventDetail");
            if (Model.Description == "<p><br></p>" || Model.ContactInfo.Name == "" || Model.ContactInfo.PhoneNo == "" || Model.ContactInfo.Email == "" || Model.Name == "")
            {
                ToastService.ShowWarning("Please Try Again :)", "Marked fields are mandatory");
                return;
            }
    ...
    public async Task OnInputFileChange(InputFileChangeEventArgs e)
    {
        ...
        foreach (var imageFile in e.GetMultipleFiles(maxAllowedFiles))
        {
            ...
            Model.CoverImage = await UploaderService.UploadFile(data);
            StateHasChanged();
