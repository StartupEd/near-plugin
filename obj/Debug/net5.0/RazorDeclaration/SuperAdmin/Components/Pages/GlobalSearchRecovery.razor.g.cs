...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/root/recovery-index")]
...
#nullable restore
#line 99 "/Users/ankitbuti/workspace/bigapple_corev3/UXs/Incubation/SuperAdmin/Components/Pages/GlobalSearchRecovery.razor"
       
    private List<Events> EventInfos { get; set; } = new List<Events>();
    private List<User> UserInfos { get; set; } = new List<User>();
    private List<Groups> GroupInfos { get; set; } = new List<Groups>();
    ...
    private Events_ClientService EventsService { get; set; }
    private User_ClientService UserService { get; set; }
    public Group_ClientService GroupService { get; set; }
    public IncubationProgram_ClientService IncubationProgramService { get; set; }
    public BusinessPage_ClientService BusinessPageService { get; set; }
    ...
    {
        EventsService = new Events_ClientService(EngineServices.MarketNetwork);
        ...
        IncubationProgramService = new IncubationProgram_ClientService(EngineServices.MarketNetwork);
        BusinessPageService = new BusinessPage_ClientService(EngineServices.MarketNetwork);
