...
export function SelectPage() {
    const a = $('.page-category.active > span').html();
    return a;
}

// Class definition
export function Wizard(wizardID, formID) {
    ...
    // Base elements
    var _wizardEl = document.getElementById(wizardID);;
    var _formEl = document.getElementById(formID);
    var _wizard;
    var _validations = [];
